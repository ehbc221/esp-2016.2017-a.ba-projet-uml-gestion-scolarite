...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('um2qs6j9Iu', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GJr-OEYzVf', 0, 'kAoTYzL6ucQZ3rHRRL2DkM', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '35.166.122.132', 'port' => 3306, 'dbname' => 'gestionscolarite', 'user' => 'gestionscolarite', 'password' => '9INwgKaGdRPiDyH3rGWea3YDt7', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/GFS/statistiquesBundle/Entity'), 1 => ($this->targetDirs[3].'/src/GFS/MainBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'GFS\\statistiquesBundle\\Entity');
        $c->addDriver($b, 'GFS\\MainBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('GFSstatistiquesBundle' => 'GFS\\statistiquesBundle\\Entity', 'GFSMainBundle' => 'GFS\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_45e74c1132254c47240ee302d1d570561a11c7991a9e4d8a2486d17e8564d0e6');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('qAE4Tsgcz0', NULL, 'kAoTYzL6ucQZ3rHRRL2DkM', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/gestionScolarite');
        ...
        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, 'gfs_main_loginpage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        $l->setOptions(array('login_path' => 'gfs_main_loginpage', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m->setOptions(array('login_path' => 'gfs_main_loginpage', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.main_provider']) ? $this->services['security.user.provider.concrete.main_provider'] : $this->getSecurity_User_Provider_Concrete_MainProviderService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'main', $l, $m, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58a65324e7fa31.52778617', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'gfs_main_loginpage', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.main_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/GFS/statistiquesBundle/Resources/views'), 'GFSstatistiques');
        $instance->addPath(($this->targetDirs[3].'/src/GFS/MainBundle/Resources/views'), 'GFSMain');
        $instance->addPath(($this->targetDirs[3].'/vendor/sonata-project/intl-bundle/Resources/views'), 'SonataIntl');
        $instance->addPath(($this->targetDirs[3].'/src/GFS/attestationBundle/Resources/views'), 'GFSattestation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9c91def9010dd42622c22e6671c38c5b25d1f7fe');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nzdOKTTZQB', 0, 'kAoTYzL6ucQZ3rHRRL2DkM', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.main_provider']) ? $this->services['security.user.provider.concrete.main_provider'] : $this->getSecurity_User_Provider_Concrete_MainProviderService()) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a65324e7fa31.52778617')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_CHEF_DEPARTEMENT' => array(0 => 'ROLE_CHEF_DEPARTEMENT')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'GFSMainBundle:User', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GFSstatistiquesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GFS/statistiquesBundle'),
                    'namespace' => 'GFS\\statistiquesBundle',
                ),
                'GFSMainBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GFS/MainBundle'),
                ...
                'GFSattestationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GFS/attestationBundle'),
                    'namespace' => 'GFS\\attestationBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GFSstatistiquesBundle' => 'GFS\\statistiquesBundle\\GFSstatistiquesBundle',
                'GFSMainBundle' => 'GFS\\MainBundle\\GFSMainBundle',
                'SonataIntlBundle' => 'Sonata\\IntlBundle\\SonataIntlBundle',
                'GFSattestationBundle' => 'GFS\\attestationBundle\\GFSattestationBundle',
            ...
            'secret' => '9c91def9010dd42622c22e6671c38c5b25d1f7fe',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '9c91def9010dd42622c22e6671c38c5b25d1f7fe',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_CHEF_DEPARTEMENT' => array(
                    0 => 'ROLE_CHEF_DEPARTEMENT',
                ),
            ),
