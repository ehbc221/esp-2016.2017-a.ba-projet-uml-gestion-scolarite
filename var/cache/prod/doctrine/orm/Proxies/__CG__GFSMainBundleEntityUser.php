...
namespace Proxies\__CG__\GFS\MainBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \GFS\MainBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'locked', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'deleted', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'GFS\\MainBundle\\Entity\\User' . "\0" . 'roles'];
        }
